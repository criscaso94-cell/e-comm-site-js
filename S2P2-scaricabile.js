...
for(let i=0;i<utenti.length;i++){
  let u=utenti[i]
  if(u.isAmbassador===true){
    console.log(u.name+""+u.lastName+" "+"è un ambassador")
  }
  else{
    console.log(u.name+""+u.lastName+" "+"non è un ambassador")
  }
}

let totale=0
for(let i =0;i<prices.length;i++){
  let carrello=prices[i]
...
for(let i=0;i<utenti.length;i++){
  let vero=utenti[i]
if(vero.isAmbassador===true){
utenteAmbassador.push(vero)
}}